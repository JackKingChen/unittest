...
struct hid_device_info  HID_API_EXPORT *hid_enumerate(unsigned short vendor_id, unsigned short product_id, int interface_number)
{
    struct hid_device_info *root = NULL; /* return object */
    struct hid_device_info *cur_dev = NULL;
    struct hid_device_info *ret_dev = NULL;
    CFIndex num_devices;
    int i;
...
hid_device * HID_API_EXPORT hid_open(unsigned short vendor_id, unsigned short product_id, int interface_number, const wchar_t *serial_number)
{
    /* This function is identical to the Linux version. Platform independent. */
    ...
    devs = hid_enumerate(vendor_id, product_id,interface_number);
    cur_dev = devs;
    while (cur_dev) {
...
void move_pthread_to_realtime_scheduling_class(pthread_t pthread)
{
    ...
    if (kr != KERN_SUCCESS) {
        ...
        printf("thread_policy_set failed:%d\n", kr);
    }
}
...
hid_device * HID_API_EXPORT hid_open_path(const char *path)
{
    ...
    if (ret == kIOReturnSuccess) {
        ...
        move_pthread_to_realtime_scheduling_class(dev->thread);
